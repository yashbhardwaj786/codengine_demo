...
public class LayoutCartItemBindingImpl extends LayoutCartItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.increase, 5);
        sViewsWithIds.put(R.id.decrease, 6);
    }
    // views
    @NonNull
    ...
    public LayoutCartItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private LayoutCartItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            ...
            setData((com.codengineassessment.data.model.CartItemProduct) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setData(@Nullable com.codengineassessment.data.model.CartItemProduct Data) {
        this.mData = Data;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.codengineassessment.data.model.CartItemProduct data = mData;
        java.lang.String javaLangStringDataQuantity = null;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
                ...
                // read ("") + (data.quantity)
                javaLangStringDataQuantity = ("") + (dataQuantity);
        }
        // batch finished
        if ((dirtyFlags & 0x6L) != 0) {
            // api target 1
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.quantity, javaLangStringDataQuantity);
        }
    }
