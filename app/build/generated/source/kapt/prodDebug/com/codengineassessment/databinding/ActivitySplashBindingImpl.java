...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.codengineassessment.ui.viewmodel.MainViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.codengineassessment.ui.viewmodel.MainViewModel ViewModel) {
